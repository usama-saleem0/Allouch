...
.poxi-1 img[data-v-16676cac][data-v-16676cac] {
    border-radius: 80px;
    width: 60px;
    height: 60px;
    flex-shrink: 0;
}
.poxi-titel h2[data-v-16676cac][data-v-16676cac] {
    color: #000;
    font-family: fantasy;
    font-size: 18px;
    font-style: normal;
...
.poxi-1[data-v-16676cac][data-v-16676cac] {
    width: 100%;
    display: flex;
    align-items: center;
    gap: 10px;
}
.poxi2-titel h2[data-v-16676cac][data-v-16676cac] {
    color: #000;
    font-family: fantasy;
    font-size: 23px;
    font-style: normal;
...
.poxi2-titel0 h2[data-v-16676cac][data-v-16676cac] {
    color: #000;
    font-family: fantasy;
    font-size: 24px;
    font-style: normal;
...
.poxi3-box[data-v-16676cac][data-v-16676cac] {
    width: 48%;
    display: flex;
    align-items: center;
    gap: 3px;
