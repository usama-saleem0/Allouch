    ...
    z-index: 1;"/> -->
      ...
      />
        ...
        <div class="form-col-2">
            ...
            <div class="buttons" >
                        <button class="Hire" style="background-color: #f96; color: white;" @click="save">Edit Profile<svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="none" >
...
export default {
    ...
    formData.append('username', this.form.user_name);
                ...
                byMethod(this.method, '/api/edit_profile' , formData)
                     .then((res) => {
