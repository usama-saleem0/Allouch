<template>
    <section class="form-1-sec" >
        <div class="main-form" v-if="showw">
            <div class="form-img">
            ...
            <div class="form-box">
                ...
                <form action="" class="form-1">
                    ...
                    <div class="input-group-2" @click="datas('Ecommerce' , 1)" :style="{ backgroundColor: bgColor1 }"><h2>Ecommerce</h2></div>
                    <div class="input-group-2" @click="datas('Enterprise B2C' , 2)" :style="{ backgroundColor: bgColor2 }"><h2>Enterprise B2C</h2></div>
                    <div class="input-group-2" @click="datas('Restaurant' , 3)" :style="{ backgroundColor: bgColor3 }"><h2>Restaurant</h2></div>
                    <div class="input-group-2" @click="datas('Agency' , 4)" :style="{ backgroundColor: bgColor4 }"> <h2>Agency</h2></div>
                    <div class="input-group-2" @click="datas('Appliction Mobile' , 5)" :style="{ backgroundColor: bgColor5 }"><h2>Appliction Mobile</h2></div>
                    <div class="input-group-2" @click="datas('Distribution' , 6)" :style="{ backgroundColor: bgColor6 }"><h2>Distribution</h2></div>
                    <div class="input-group-2" @click="datas('Automobile' , 7)" :style="{ backgroundColor: bgColor7 }"><h2>Automobile</h2></div>
                ...
                <a  @click="$emit('cancel')"   class="form-last">
        ...
        <div v-if="count">
      <Country :user-id="user_id" @cancel="closeModal"/>
...
this.form.businesstype = this.company_type;
    ...
    byMethod(this.method, 'businesstype' , this.form)
        .then((res) => {
